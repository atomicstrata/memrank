...
class HindsightAdapter(MemoryAdapter):
    ...
    def __init__(
        ...
        # -- see localdocs/engines/engine-hindsight.md. Since 2026-08-19 that variant is the BARE
        ...
        # the published numbers (localdocs/engines/engine-hindsight.md section 3). `hindsight:matched` clears
